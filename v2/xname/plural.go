...
func compile() {
	...
	for _, value := range plurals.IrregularReplacements {
		replacements := []replacement{
			...
			{regexp: regexp.MustCompile(xstring.Title(value.Singular) + "$"), replace: xstring.Title(value.Plural)},
	...
	for _, value := range plurals.IrregularReplacements {
		replacements := []replacement{
			...
			{regexp: regexp.MustCompile(xstring.Title(value.Plural) + "$"), replace: xstring.Title(value.Singular)},
