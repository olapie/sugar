...
func compile() {
	...
	for _, value := range plurals.IrregularReplacements {
		replacements := []replacement{
			...
			{regexp: regexp.MustCompile(stringx.Title(value.Singular) + "$"), replace: stringx.Title(value.Plural)},
	...
	for _, value := range plurals.IrregularReplacements {
		replacements := []replacement{
			...
			{regexp: regexp.MustCompile(stringx.Title(value.Plural) + "$"), replace: stringx.Title(value.Singular)},
